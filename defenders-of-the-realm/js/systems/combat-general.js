...
Object.assign(game, {
    useSpecialSkill() {
        ...
        switch(hero.name) {
            case 'Paladin':
            case 'Errant Paladin': // v2: same Noble Steed ability as Paladin
                this.useNobleSteed();
                break;
            case 'Wizard':
    ...
    _continueGroupAttackerCombat(hero, general, cardsToUse) {
        ...
        // v2: Noble Dwarf shares Dragon Slayer with Dwarf
    ...
    _rollGroupAttackerDice(hero, general, cardsToUse) {
        ...
        const canDwarfGroupReroll = (hero.name === 'Dwarf' || hero.name === 'Noble Dwarf') // v2: Noble Dwarf
